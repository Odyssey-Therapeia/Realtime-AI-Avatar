...
export function ConsolePage() {
  ...
  const startRecording = async () => {
    const wavRecorder = wavRecorderRef.current;
    if (!isConnected) { // `isConnected` should be a state variable that tracks connection status
      alert("Please connect first before starting push-to-talk");
      return; // Stop execution if not connected
    }
  
    // Check if the recorder is already active before starting a new recording session
    if (wavRecorder.recording) {
      console.warn('Recorder is already recording. No need to start again.');
      return; // Exit early if already recording
    }
  
    setIsRecording(true); // Update the state to reflect the recording status
    const client = clientRef.current;
    const wavStreamPlayer = wavStreamPlayerRef.current;
    
    // Interrupt the stream player if needed
  ...
  const stopRecording = async () => {
    ...
    // Check if the recorder is currently recording before pausing
    if (!wavRecorder.recording) {
      console.warn('Recorder is already paused. No need to pause again.');
      return;
    }
  
    setIsRecording(false); // Update the state to show recording stopped
    const client = clientRef.current;
  ...
  return (
    <div data-component="ConsolePage">
      <div className="content-top">
        ...
        <img src="/new_logo.png" alt="Odyssey Concierge Logo" />
        {/* <span>Odyssey Concierge</span> */}
        </div>
      ...
      <div className="content-main">
        ...
        <div className="content-container">
          ...
          <div className="content-conversation">
            ...
            <div className="content-block conversation">
              ...
              <div className="content-block-body" data-conversation-content>
                <div className="center-text">
                  {!items.length && "...let's get connected to our virtual AI Athena!"}
                </div>
            ...
            <div className='button-visualization'>
                ...
                <div className="button-container">
                  <Button
                    ...
                    style={{ backgroundColor: isRecording ? 'red' : 'green', color: 'white' }} // Use green for regular
